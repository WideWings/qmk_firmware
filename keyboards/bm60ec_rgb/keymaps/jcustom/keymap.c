...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______,   _______,   _______,                      KC_UNDS,                              _______, _______, TG(3), KC_END, _______
    ),
	[2] = LAYOUT(
    ...
    [6] = LAYOUT(
        ...
        _______,     M_JQUERY, M_DIV, M_DIVEND, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______,            _______, _______, M_JSLOG, M_VDUMP, _______, _______, _______, A(KC_LEFT), A(KC_RIGHT), C(KC_T),        KC_PGUP, _______,
        _______,   _______,   _______,                      _______,                              G(KC_E), C(A(KC_DEL)), C(S(KC_T)), KC_PGDOWN, C(KC_W)
    ),
    [7] = LAYOUT(
